    ...
    <Row>
      <Col span={24} style={styles.mainCol}>
        <Space direction="vertical" size="small" style={styles.contentSpace}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to QuestMind.AI.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Country</strong> refers to: El Salvador
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to QuestMind.AI, accessible from{" "}
                <a
                  href="https://questmind.ai/"
          ...
          <ul>
            <li>By email: support@questmind.ai</li>
          </ul>
        </Space>
      </Col>
    </Row>
